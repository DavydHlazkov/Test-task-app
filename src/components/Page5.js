      ...
      <div className="form-input-block">
        <div className={nameError ? "unique-input error" : "unique-input"}>
          <input
            ...
            value={userData.p5Name}
            onChange={(e) =>
              setUserData({ ...userData, p5Name: e.target.value })
            }
          />
        </div>
        <div className={surnameError ? "unique-input error" : "unique-input"}>
          <input
            ...
            value={userData.p5Surname}
            onChange={(e) =>
              setUserData({ ...userData, p5Surname: e.target.value })
            }
          />
        </div>
        <div className={emailError ? "unique-input error" : "unique-input"}>
          <input
            ...
            value={userData.p5Email}
            onChange={(e) =>
              setUserData({ ...userData, p5Email: e.target.value })
            }
          />
        </div>
        <div className={phoneError ? "unique-input error" : "unique-input"}>
          <input
            ...
            value={userData.p5Phone}
            onChange={(e) =>
              setUserData({ ...userData, p5Phone: e.target.value })
            }
          />
        </div>
      </div>
